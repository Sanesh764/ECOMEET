...
export default function Register() {
  const { register, setRoute, loading } = useApp();
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      if (res.simulated) {
        setSuccessMsg('Simulated registration successful! Redirecting to login...');
      } else {
      ...
      <div className="w-full lg:grid lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col justify-between bg-radial from-indigo-950/30 to-[#07080a] border-r border-white/5 p-12 relative overflow-hidden">
          ...
          <div className="z-10 my-auto flex flex-col gap-6 max-w-lg">
            ...
            >
              Join the future of clean remote communication.
            </motion.h2>
            ...
            >
              Create a free account in less than 30 seconds. Get access to HD video streams, customizable backgrounds, encrypted direct chats, and collaborative tools.
            </motion.p>
          </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="terms-conditions" className="ml-2 block text-xs font-medium text-gray-400">
                  I accept the{' '}
